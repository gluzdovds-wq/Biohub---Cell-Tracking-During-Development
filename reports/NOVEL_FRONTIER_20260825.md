...
3. EXP068 tests a global min-cost-flow association family with only `0.602` edge overlap.
4. EXP069 keeps a high-score calibration arm while materially increasing the number of predicted divisions.
