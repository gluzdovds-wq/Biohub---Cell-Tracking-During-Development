...
| EXP-011 | 2026-08-22 | EXP-009 checkpoint | Holdout-`44b6` official-metric audit: choose detection threshold from `0.95/0.97/0.985/0.99/0.995` and linker from greedy/public-ILP/support-ILP on the frozen calibration eight, persist the pair, then evaluate the untouched audit remainder once. | strict held-out audit contract | not a test submission | target T4 | prepared | UNet candidates are shared across linker policies; no repair or audit-driven sweep. Depends on successful EXP-009 completion. |
