...
| EXP-011 | 2026-08-22 | EXP-009 checkpoint | Holdout-`44b6` official-metric audit: choose detection threshold from `0.95/0.97/0.985/0.99/0.995` on the frozen calibration eight, persist the choice, then evaluate the untouched audit remainder once. | strict held-out audit contract | not a test submission | target T4 | prepared | Greedy graph constraints fixed at one parent/two children; no ILP or graph repair sweep. Depends on successful EXP-009 completion. |
| EXP-012 | 2026-08-22 | EXP-010 checkpoint | Reciprocal holdout-`6bba` official-metric audit with exactly the EXP-011 protocol. | strict held-out audit contract | not a test submission | target T4 | prepared | Provides fold variance and a non-leaking gate for later TTA/ILP/repair experiments. Depends on successful EXP-010 completion. |
